        ...
        <div className="w-full max-w-md rounded-xl border border-slate-800 bg-slate-900/40 p-8 shadow-2xl backdrop-blur-md">
          ...
          <form onSubmit={handleLoginSubmit(onLogin)} className="space-y-4">
            <div>
              ...
              <input
                {...loginRegister('email')}
                className="w-full rounded-lg border border-slate-700 bg-slate-800/60 p-2.5 text-slate-100 outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all"
            ...
            <form onSubmit={handleRegisterSubmit(onRegister)} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-700 bg-slate-800 p-2.5 text-slate-100 outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all"
