    ...
    <div className="mx-auto max-w-2xl py-12">
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-slate-400">
          Para acessar todos os recursos do Hebrom Sys, como pedidos de oração e comunicados, solicite seu acesso como membro.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div>
            ...
            <input
              {...register('fullName')}
              className="w-full rounded-md border border-slate-700 bg-slate-800 p-2.5 text-slate-100 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-300">Telefone / WhatsApp</label>
            <input
              {...register('phone')}
              className="w-full rounded-md border border-slate-700 bg-slate-800 p-2.5 text-slate-100 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
          ...
          <button
            ...
            className="mt-6 w-full rounded-md bg-blue-600 px-4 py-2.5 font-medium text-white transition-colors hover:bg-blue-700 disabled:opacity-70"
          >
