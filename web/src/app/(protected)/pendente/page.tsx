  ...
  return (
    <div className="flex h-full flex-col items-center justify-center py-12">
      <div className="max-w-md text-center">
        <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-amber-900/30">
        ...
        <p className="mb-8 text-slate-400">
          ...
          validado, você terá acesso a todos os recursos da plataforma Hebrom Sys.
        </p>

        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-6">
          <p className="text-sm text-slate-300">
            Enquanto aguarda, você pode fechar o aplicativo. Nós o avisaremos (ou verifique
